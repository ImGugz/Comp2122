...
namespace l22 {
  ...
  class frame_size_calculator: public basic_ast_visitor {
    ...
    std::shared_ptr<l22::symbol> _symbol;
  ...
  public:
    frame_size_calculator(std::shared_ptr<cdk::compiler> compiler, cdk::symbol_table<l22::symbol> &symtab, std::shared_ptr<l22::symbol> symbol) :
        basic_ast_visitor(compiler), _symtab(symtab), _symbol(symbol),
