...
instruction :  simple_expr                        { $$ = new l22::evaluation_node(LINE, $1); }
            ...
            |  tITERATE expr tCOUNT expr tWITH tIDENTIFIER tIF simple_expr { $$ = new l22::iterate_node(LINE, $2, $4, *$6, $8); delete $6; }
            ;
...
blockinstr  :  block_expr                         { $$ = new l22::evaluation_node(LINE, $1); }
            ...
            |  block                              { $$ = $1; }
            |  tITERATE expr tCOUNT expr tWITH tIDENTIFIER tIF block_expr { $$ = new l22::iterate_node(LINE, $2, $4, *$6, $8); delete $6;  }
            ;
