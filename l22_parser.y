...
%type <sequence> file declarations instructions opt_exprs exprs simple_exprs block_exprs opt_vars vars
...
declaration:   tPUBLIC   type tIDENTIFIER opt_expr        { $$ = new l22::declaration_node(LINE, tPUBLIC, $2, *$3, $4); delete $3; }
           ...
           |   tPUBLIC   tVAR tIDENTIFIER expr_assignment { $$ = new l22::declaration_node(LINE, tPUBLIC, nullptr, *$3, $4); delete $3; }
